...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('content'); ?> 
        <div class="transactions">
            <div class="header">
                <div class="label">MY TRANSACTIONS</div>
                <hr>
            ...
            <div class="table-row">
                ...
                <div class="value short">01.05.2021</div>
                <div class="parameter">In Progress</div>
            </div>
            <hr>
            <div class="table-row">
                <div class="value center"><a href="" class="fas fa-file-alt user"></a></div>
...
<?php endif; ?> 
<?php /**PATH C:\Users\user\openserver\OSPanel\domains\hotel.com\resources\views/transactions.blade.php ENDPATH**/ ?>